...
export async function MunSP(page, params) {
	try{
		await sleep(500);
		await clickElementByXpath(page,'/html/body/div/div/form/div[2]/div/div[5]/div[2]/fieldset/div/div[1]/span[2]/input');
		await clickElementByXpath(page,'/html/body/div/div/form/div[2]/div/div[5]/div[2]/fieldset/div/div[2]/fieldset/span/label/input');
    ...
    console.error('Error during consult MUN SP:', error);
    return {
      status: false,
      data: error
    };
