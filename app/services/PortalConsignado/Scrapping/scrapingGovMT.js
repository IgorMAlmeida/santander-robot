...
export async function scrapingGovMT(page) {
		...
		produtos.push({
			...
			'Margem Bruta': {
				'Provimento 1': {
                    ...
                    'Consignações Compulsórias	': await getElementTextByXpath(page, '/html/body/div/div/div[2]/div/form/div[2]/div/div[4]/div[1]/div/span/div/div[3]/div[2]/div/div/span/div/table/tbody/tr[4]/td[2]/span'),
                }
			},
			'Margem Disponível - Total' : {
				'Provimento 1': {
                    ...
                    'Consignações Compulsórias	': await getElementTextByXpath(page, '/html/body/div/div/div[2]/div/form/div[2]/div/div[4]/div[1]/div/span/div/div[4]/div[2]/div/div/span/div/table/tbody/tr[4]/td[2]/span'),
                }
			}
		});
